...
export default {
	...
	computed: {
		...
		markerBorderColor() {
			const { r, g, b } = this.gridModule.markerBorderColor;
			return `rgb(${r},${g},${b})`;
		},
		cssVars() {
			...
			return {
				...
				"--grid-count-font-color": `rgb(${this.gridModule.countsColor.r},${this.gridModule.countsColor.g},${this.gridModule.countsColor.b})`,
